...
write.table(predict, file = "Case2PredictionsTRUONG Attrition.csv", sep=",")
...
predict2 = Predict_Salary[,c("ID","MonthlyIncome")]
summary(predict2)

write.table(predict2, file = "Case2PredictionsTRUONG Salary.csv", sep=",")
...
```
###VIDEO LINK
https://www.screencast.com/t/4BLLUKP56
